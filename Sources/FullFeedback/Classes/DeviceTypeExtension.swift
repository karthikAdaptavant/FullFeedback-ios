...
public extension UIDevice {
	...
	var isIphoneMax: Bool {
		return xMaxDevices.contains(UIDevice.current.modelName)
	}
	...
	var modelName: String {
		...
		switch identifier {
			case "iPhone3,1", "iPhone3,2", "iPhone3,3": return "iPhone 4" // Iphones
			...
			case "i386", "x86_64": return "Simulator" // Simulator
			case "iPad1,1" : return "iPad" // Ipads
